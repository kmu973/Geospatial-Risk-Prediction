...
do.call(grid.arrange,c(varList, ncol = 4, top = "Local Morans I statistics, countMVTheft"))
...
final_net <-
  ...
  mutate(theft.isSig.dist = 
           nn_function(st_c(st_coid(final_net)),
                       st_c(st_coid(filter(final_net, theft.isSig == 1))), 
                       k = 1))

ggplot() +
      geom_sf(data = final_net, aes(fill=theft.isSig.dist), colour=NA) +
      scale_fill_viridis(name="NN Distance") +
      labs(title="Theft NN Distance") +
      mapTheme()
